...
exports.MAX_EARL_LENGTH = 10;
exports.SUCCESS = {
  'added_earl' : {
    succes: 'added_earl',
    message: "Successfully created TinyEarl!"
  },
  'modified_earl' : {
    succes: 'modified_earl',
    message: "Successfully modified TinyEarl!"
  },
  'deleted_earl' : {
    succes: 'deleted_earl',
    message: "Successfully deleted TinyEarl!"
  }
};
exports.ERRORS = {
  'not_logged_in' : { 
